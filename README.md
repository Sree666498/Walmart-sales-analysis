Project Overview
This project is part of my ongoing learning in data analytics and explores Walmart sales and customer behavior using PostgreSQL, Python, and VS Code. While the project follows a guided tutorial by Zero Analyst, I extended it by:
...
Data Source: Walmart Sales Dataset on GitHub
